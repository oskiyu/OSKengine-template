...
void main() {
    ...
    // Directional Light
    accummulatedRadiance += CalculateShadowStrength(fragPosInCameraViewSpace, dirLightShadowMat.matrix, dirLightShadowMat.splits, dirLightShadowMap, inPosition, 1) 
